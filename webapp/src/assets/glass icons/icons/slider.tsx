...
function Slider({fill = 'currentColor', secondaryfill, title = 'badge 13', ...props}: IconProps) {
	...
	<g fill="none">
		...
		<path clipPath="url(#1752500502803-117796_slider_clipPath_vbo3uq7ur)" d="M21 16C21.5523 16 22 16.4477 22 17C22 17.5523 21.5523 18 21 18H6C5.44772 18 5 17.5523 5 17C5 16.4477 5.44772 16 6 16H21ZM18 6C18.5523 6 19 6.44772 19 7C19 7.55228 18.5523 8 18 8H3C2.44772 8 2 7.55228 2 7C2 6.44772 2.44772 6 3 6H18Z" fill="url(#1752500502803-117796_slider_existing_0_hyresn85p)" data-glass="clone"/>
